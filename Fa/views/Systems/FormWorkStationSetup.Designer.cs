namespace fa.views.Systems
{
    partial class FormWorkStationSetup
    {
        ...
        private void InitializeComponent()
        {
            ...
            ComboBoxBarcodeLabel = new ComboBox();
            label9 = new Label();
            label8 = new Label();
            label7 = new Label();
            label5 = new Label();
            ...
            groupBox1.Controls.Add(ComboBoxBarcodeLabel);
            ...
            ComboBoxDefaultStockLocation.Location = new Point(13, 249);
            ...
            // 
            // ComboBoxBarcodeLabel
            // 
            ComboBoxBarcodeLabel.FormattingEnabled = true;
            ComboBoxBarcodeLabel.Items.AddRange(new object[] { "25mm * 20 mm", "35 mm * 25 mm", "50 mm * 25 mm", "100 mm* 23 mm" });
            ComboBoxBarcodeLabel.Location = new Point(228, 249);
            ComboBoxBarcodeLabel.Name = "ComboBoxBarcodeLabel";
            ComboBoxBarcodeLabel.Size = new Size(145, 21);
            ComboBoxBarcodeLabel.TabIndex = 16;
            // 
            // label9
            // 
            label9.AutoSize = true;
            label9.Location = new Point(228, 233);
            label9.Name = "label9";
            label9.Size = new Size(117, 13);
            label9.TabIndex = 14;
            label9.Text = "Default Bar Code Label";
            // 
            // label8
            // 
        ...
        private ComboBox ComboBoxBarcodeLabel;
    }
}
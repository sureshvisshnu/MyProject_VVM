    ...
    public class ComboTreeDropDown : ToolStripDropDown
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = _scrollOffset; i < (_scrollOffset + _numItemsDisplayed); i++)
            {
                ...
                // Define custom highlight color
                Brush bgBrush = highlighted ? Brushes.WhiteSmoke : Brushes.White; // Adjust color as needed

                // Fill background with custom highlight color
                e.Graphics.FillRectangle(bgBrush, item.DisplayRectangle);

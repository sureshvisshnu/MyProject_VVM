...
{
#if NET35
[Designer("System.Windows.Forms.Design.UpDownBaseDesigner, System.Design, Version=2.0.0.0, Culture=neutral, PublicKeyToken=03f5f7f11d50a3a"), ToolboxItem(false), DesignerCategory("")]
#else
    ...
    public abstract class DropDownControlBase : Control
    {
        ...
        internal static void DrawLegacyComboBox(Graphics graphics, Rectangle bounds, Rectangle buttonBounds, Color backColor, ButtonState state)
        {
            ...
            ControlPaint.DrawBorder3D(graphics, borderRect, Border3DStyle.Flat);
            //ControlPaint.DrawBorder(graphics, borderRect, backColor, ButtonBorderStyle.Outset);
        ...
        void bufferedPainter_PaintVisualState(object sender, BufferedPaintEventArgs<ComboBoxState> e)
        {
            if (_drawWithVisualStyles && _bufferedPainter.BufferedPaintSupported && _bufferedPainter.Enabled)
            {
                ...
                //e.Graphics.FillRectangle(new SolidBrush(Color.White), _dropDownButtonBounds);

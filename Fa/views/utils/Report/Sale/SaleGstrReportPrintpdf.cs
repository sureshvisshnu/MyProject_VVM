...
{
    public class SaleGstrReportPrintpdf
    {
        ...
        public void GeneratePDF(DataTable dataTable, string heading, string fileName, string fileExtension, bool isPrint, string FromDate, string Todate)
        {
            ...
            {
                Document pdfDoc = new Document(fileName == "SalesGSTRReportBTOB" || fileName == "SalesGSTRReportBTOBO" ? PageSize.A4.Rotate() : PageSize.A4, -45, -45, 20, 20);
                ...
                if (fileName == "SalesGSTRReportBTOB" || fileName == "SalesGSTRReportBTOBO")
                {
        ...
        private PdfPTable MainTable(DataTable DataTable, String TypeOfReport)
        {
            ...
            float[] widths = null;
            if (TypeOfReport == "SalesGSTRReportHSN")
            {
                widths = new float[] { 20f, 30f, 40f, 30f, 30f, 30f, 30f, 30f, 30f, 30f };
            }
            if (TypeOfReport == "SalesGSTRReportBTOB")
            {
                widths = new float[] { 20f, 30f, 40f, 30f, 30f, 28f, 60f, 28f, 28f, 28f, 28f, 30f, 30f };
            }
            if (TypeOfReport == "SalesGSTRReportBTOCL")
            {
                widths = new float[] { 20f, 30f, 30f, 30f, 50f, 30f, 30f, 30f, 30f };
            }
            if (TypeOfReport == "SalesGSTRReportBTOCS")
            {
                widths = new float[] { 20f, 30f, 50f, 30f, 30f, 30f, 30f };
            }
            if (TypeOfReport == "SalesGSTRReportBTOBO")
            {
                widths = new float[] { 20f, 30f, 40f, 30f, 30f, 28f, 60f, 28f, 28f, 28f, 28f, 30f, 30f };
            }
            ...
            foreach (DataColumn column in DataTable.Columns)
            {
                ...
                if (column.Caption == "Total Quantity" || column.Caption == "Total Value"
                    ...
                    || column.Caption == "Taxable Value" || column.Caption == "Rate" || column.Caption == "Value")
                {
